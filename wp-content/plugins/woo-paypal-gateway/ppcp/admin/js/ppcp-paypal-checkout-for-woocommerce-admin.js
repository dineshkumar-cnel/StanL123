(function ($) {
    ...
    $(function () {
        ...
        var is_pay_later_messaging_enable = function () {
            if (jQuery('#woocommerce_wpg_paypal_checkout_enabled_pay_later_messaging').is(':checked')) {
                return true;
            }
            return false;
        };
        var is_pay_later_messaging_home_page_enable = function () {
            ...
            if (jQuery.inArray('home', jQuery('#woocommerce_wpg_paypal_checkout_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
        ...
        var is_pay_later_messaging_category_page_enable = function () {
            ...
            if (jQuery.inArray('category', jQuery('#woocommerce_wpg_paypal_checkout_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
        ...
        var is_pay_later_messaging_product_page_enable = function () {
            ...
            if (jQuery.inArray('product', jQuery('#woocommerce_wpg_paypal_checkout_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
        ...
        var is_pay_later_messaging_cart_page_enable = function () {
            ...
            if (jQuery.inArray('cart', jQuery('#woocommerce_wpg_paypal_checkout_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
        ...
        var is_pay_later_messaging_payment_page_enable = function () {
            ...
            if (jQuery.inArray('payment', jQuery('#woocommerce_wpg_paypal_checkout_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
